...
puts "\033\[0;32mCyberPress 上传工具\033\[0m"
puts "\033\[0;32m========================================\033\[0m"
puts ""
...
expect {
    "password:" {
        ...
        expect {
            "100%" {
                puts "\n\033\[0;32m✓ 上传成功！\033\[0m"
            }
            eof {
                puts "\n\033\[0;32m✓ 上传完成！\033\[0m"
            }
            timeout {
                puts "\n\033\[0;31m✗ 上传超时\033\[0m"
                exit 1
            }
        }
    }
    timeout {
        puts "\033\[0;31m✗ 连接超时\033\[0m"
        exit 1
    }
}
...
puts ""
puts "下一步："
puts "  部署: \033\[1;33mbash deploy/deploy.sh\033\[0m"
puts ""

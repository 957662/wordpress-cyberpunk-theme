...
export function CacheIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M15.5 15.5a2.5 2.5 0 0 0 0-5" />
    </svg>
  );
}
...
export function RocketIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M9 12H4s.55-3.03 2-4c1.62-1.1 2.75-2 5-2 1.25 0 2.36.36 3.23.96" />
      <path d="M12 15v5s3.03-.55 4-2c1.1-1.62 2-2.75 2-5 0-1.25-.36-2.36-.96-3.23" />
    </svg>
  );
}
